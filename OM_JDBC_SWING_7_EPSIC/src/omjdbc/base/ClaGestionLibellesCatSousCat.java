...
/**
 *
 * @author zaurak (OMDB) le 08.04.2018
 ...
 * 
 * Affichage de 3 tables provenant d'une base de données de gestion des libellés de problèmes (Physique, Maths, Histoire, etc)
 * bref toutes les questions qu'un prof peut poser aux élèves pour les faire transpirer par pure humiliation.
 * Un libellé est un "amas" de mots avec un point d'interrogation à la fin.
 * 
 * Un être simple peut penser que cette définition correspond à une question....
 * mais il s'agit de traiter par la suite des libellés contenant plusieurs questions,
 * donc je ne pouvais pas confondre la notion de libellé avec la notion de questions
 * Bref.... ce n'est pas important ici...
 * 
 * 
 * Il s'agit d'afficher les catégories des libellés. Il peut y avoir plusieurs catégories pour un libellé.
 * Il s'agit d'afficher les sous catégories des libellés. Il peut y avoir plusieurs sous catégories pour un libellé.
 * 
 */
...
private void requete_id_libelle() {
        try {
            ...
            */
            ...
            String sql_select_sc_cat = "SELECT DISTINCT id_libelle_probleme, Libelle_Probleme FROM t_libelles T1\n" +
    "               LEFT JOIN t_libelles_souscat T2 ON T2.fk_libelle = T1.id_libelle_probleme\n" +
    "               LEFT JOIN t_sous_categorie T3 ON T3.Id_Sous_Categorie = T2.fk_sous_categorie\n" +
    "               INNER JOIN t_libelles_categories T4 ON T4.fk_libelle = T1.id_libelle_probleme\n" +
    "               INNER JOIN t_categories T5 ON T5.id_categorie = T4.fk_categorie\n";
    ...
    */
        ...
        try{
            ...
            */
            idLibProb = rowsetrsScCat.getString("id_libelle_probleme");
            // OMDB 08.04.2018 : Affiche l'id_libelle_probleme
            jLabel1idLibelle.setText(idLibProb);

        String sql_select_cat_where = "SELECT DISTINCT Libelle_Probleme, Nom_categorie FROM t_libelles T1\n" +
"               LEFT JOIN t_libelles_souscat T2 ON T2.fk_libelle = T1.id_libelle_probleme\n" +
"               LEFT JOIN t_sous_categorie T3 ON T3.Id_Sous_Categorie = T2.fk_sous_categorie\n" +
"               INNER JOIN t_libelles_categories T4 ON T4.fk_libelle = T1.id_libelle_probleme\n" +
"               INNER JOIN t_categories T5 ON T5.id_categorie = T4.fk_categorie\n" +
"               WHERE id_libelle_probleme =" + idLibProb;

        String sql_select_sc_where = "SELECT DISTINCT Libelle_Probleme, Id_Sous_Categorie, Nom_Sous_Categorie FROM t_libelles T1\n" +
"               LEFT JOIN t_libelles_souscat T2 ON T2.fk_libelle = T1.id_libelle_probleme\n" +
"               LEFT JOIN t_sous_categorie T3 ON T3.Id_Sous_Categorie = T2.fk_sous_categorie\n" +
"               INNER JOIN t_libelles_categories T4 ON T4.fk_libelle = T1.id_libelle_probleme\n" +
"               INNER JOIN t_categories T5 ON T5.id_categorie = T4.fk_categorie\n" +
"               WHERE id_libelle_probleme =" + idLibProb;        
            ...
            while(rsCat.next())
            {
                ...
                jTextArea1Libelle.setText(rsCat.getString("Libelle_Probleme"));
                ...
                String nomCategorie = rsCat.getString("Nom_categorie");
            ...
            */           
            ...
            {
                // OMDB 04.04.2018 : Afficher le libellé dans une zone de textarea
                jTextArea1Libelle.setText(rsSc.getString("Libelle_Probleme"));
                ...
                String nomSousCategorie = rsSc.getString("Nom_Sous_Categorie");
    ...
    */
        ...
        String sql_idLibelleSousCat = "SELECT id_Libelle_SousCat  FROM t_libelles_souscat WHERE fk_libelle = ? AND fk_sous_categorie = \n"+
               " (SELECT Id_Sous_Categorie FROM t_sous_categorie WHERE Nom_Sous_Categorie COLLATE utf8_unicode_ci LIKE ?) \n"+
               " ORDER BY Date_Libelle_SousCat DESC";
        
        // OMDB 15.04.2018 : Requête pour EFFACER la ligne (id_Libelle_SousCat) dans la table de liaison entre les LIBELLES et les SOUS CATEGORIES        
        String sql_DeleteidLibelleSousCat = "DELETE FROM t_libelles_souscat WHERE id_Libelle_SousCat = ?";        		
            ...
            if (selectedIdx.length == 0) {
                ...
                */
                ...
                while (i < nbValuesSelected) {
                    ...
                    idLibelleSousCat = rsRechidLibelleSousCat.getInt("id_Libelle_SousCat");
    ...
    */
        ...
        // OMDB 24.04.2018 : Requête pour rechercher l'id de la ligne à effacer (id_Libelle_Categorie) dans la table de liaison entre les LIBELLES et les CATEGORIES
        String sql_idLibelleCat = "SELECT id_Libelle_Categorie  FROM t_libelles_categories WHERE fk_libelle = ? AND fk_categorie = \n"+
               " (SELECT id_categorie FROM t_categories WHERE Nom_categorie COLLATE utf8_unicode_ci LIKE ?) \n"+
               " ORDER BY Date_Libelle_Categorie DESC";
        
        // OMDB 24.04.2018 : Requête pour EFFACER la ligne (id_Libelle_Categorie) dans la table de liaison entre les LIBELLES et les CATEGORIES        
        String sql_DeleteidLibelleCat = "DELETE FROM t_libelles_categories WHERE id_Libelle_Categorie = ?";        		
            ...
            if (selectedIdx.length == 0) {
                ...
                */
                ...
                while (i < nbValuesSelected) {
                    ...
                    // OMDB 15.04.2018 : Récupérer le numéro de la ligne à effacer
                    idLibelleCat = rsRechidLibelleCategorie.getInt("id_Libelle_Categorie");
                    // LIGNE INUTILE...JUSTE POUR RASSURER LA PERSONNE QUI EST EN TRAIN DE CODER.....
