...
private boolean remplir_liste_categories() {
        ...
        String sql_select_categories = "SELECT Id_Categorie, Nom_Categorie COLLATE utf8_unicode_ci as Nom_Categorie  FROM t_categories ORDER BY Nom_Categorie COLLATE utf8_unicode_ci DESC";
        ...
        try{
            ...
            {
                String nomCategorie = rsCategories.getString("Nom_Categorie");
    ...
    */
        ...
        String sql_CompterDoublonsCategoriesLibelle = "SELECT count(*) AS NbDblCategorie  FROM t_libelles_categories WHERE fk_libelle = ? AND fk_categorie = ( SELECT id_categorie FROM t_categories WHERE Nom_categorie COLLATE utf8_unicode_ci LIKE ?)";
        // OMDB 28.04.2018 : On insère dans la table intermédiaire "t_libelles_categories" la ligne qui indique la correspondance entre le libellé et la catégories 
        String sql_RechercheIdCategorieInsFkCat = "INSERT INTO t_libelles_categories (id_Libelle_Categorie, fk_libelle, fk_categorie, Date_Libelle_Categorie)\n"+
                " VALUES (NULL, ?,( SELECT id_categorie FROM t_categories WHERE Nom_categorie COLLATE utf8_unicode_ci LIKE ?), CURRENT_TIMESTAMP)";
