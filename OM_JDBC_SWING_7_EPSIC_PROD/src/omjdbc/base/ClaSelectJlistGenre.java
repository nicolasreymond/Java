 ...
 * @author zaurak
 */
public class ClaSelectJlistGenre extends javax.swing.JFrame {
    ...
    public ClaSelectJlistGenre() {
        ...
        remplir_liste_genres();

    }

    public ClaSelectJlistGenre(int idLibelleRecu) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Genre sélectionnées");
    ...
    private boolean remplir_liste_genres() {
        ...
        try {
            ...
            while (rs.next()) {
                String nomSousCategorie = rs.getString("nom_genre");
    ...
    public boolean insererLibelleSousCategorieBD() {
        ...
        String sql_CompterDoublonsSousCatLibelle = "SELECT count(*) AS NbDblSc  FROM T_est WHERE fk_Video = ? AND fk_Genre = ( SELECT ID_Genre FROM T_Genre WHERE nom_genre COLLATE utf8_unicode_ci LIKE ?)";

        // OMDB 28.04.2018 : On insère dans la table intermédiaire "T_Video_souscat" la ligne qui indique la correspondance entre le libellé et la sous catégorie.         
        String sql_RechercheIdSousCategorieInsFkSousCat = "INSERT INTO T_est (ID_est, fk_Video, fk_Genre)\n"
                + " VALUES (NULL, ?,( SELECT ID_Genre FROM T_Genre WHERE nom_genre COLLATE utf8_unicode_ci LIKE ?))";
        ...
        try {
            ...
            if (selectedIdx.length == 0) {
                ...
                for (int i = 0; i < selectedIdx.length; i++) {
                    ...
                    PreparedStatement pstRechIdSc = conn.prepareStatement(sql_RechercheIdSousCategorieInsFkSousCat);
                    ...
                    // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
                    PreparedStatement pstCptDoublSousCat = conn.prepareStatement(sql_CompterDoublonsSousCatLibelle);
                    // OMDB 13.03.2018 : Passer la valeur au paramètre (défini par ?) dans la requête "sql_RechercheIdSousCategorieInsFkSousCat"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClaSelectJlistGenre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClaSelectJlistGenre().setVisible(true);
            }
        });
    }
