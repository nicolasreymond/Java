 ...
 * @author zaurak
 */
public class ClaSelectJlistRealisateur extends javax.swing.JFrame {
     ...
     */
    public ClaSelectJlistRealisateur() {
    ...
    public ClaSelectJlistRealisateur(int idLibelleRecu) {
    ...
    private boolean remplir_liste_categories() {
        ...
        String sql_selecT_Realisateur = "SELECT ID_Realisateur, nom_realisateur FROM T_Realisateur WHERE nom_Realisateur <> ''";

        try {

            // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
            PreparedStatement pstCategories = ClaConnectionBd.getConnection().prepareStatement(sql_selecT_Realisateur);
            ...
            while (rsCategories.next()) {
                String nomCategorie = rsCategories.getString("nom_realisateur");
    ...
    public boolean insererLibelleCategorieBD() {
        ...
        String sql_CompterDoublonsCategoriesLibelle = "SELECT count(*) AS NbDblCategorie  FROM T_Produit WHERE fk_Video = ? AND fk_Realisateur = ( SELECT ID_Realisateur FROM T_Realisateur WHERE nom_realisateur COLLATE utf8_unicode_ci LIKE ?)";
        // OMDB 28.04.2018 : On insère dans la table intermédiaire "T_Video_categories" la ligne qui indique la correspondance entre le libellé et la catégories 
        String sql_RechercheIdCategorieInsFkCat = "INSERT INTO T_Produit (ID_Produit, fk_Video, fk_Realisateur)\n"
                + " VALUES (NULL, ?,( SELECT ID_Realisateur FROM T_Realisateur WHERE nom_realisateur COLLATE utf8_unicode_ci LIKE ?))";
        ...
        try {
            ...
            if (selectedIdx.length == 0) {
                ...
                final Connection conn = ClaConnectionBd.getConnection();
                ...
                for (int i = 0; i < selectedIdx.length; i++) {
                    ...
                    PreparedStatement pstRechIdCategorie = conn.prepareStatement(sql_RechercheIdCategorieInsFkCat);
                    ...
                    // OMDB 13.03.2018 : "préparer" la requête (ici sans paramètres) pour la BD.
                    PreparedStatement pstCptDoublCategorie = conn.prepareStatement(sql_CompterDoublonsCategoriesLibelle);
                    // OMDB 13.03.2018 : Passer la valeur au paramètre (défini par ?) dans la requête "sql_RechercheIdSousCategorieInsFkSousCat"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClaSelectJlistRealisateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClaSelectJlistRealisateur().setVisible(true);
            }
        });
    }
