 ...
 *
 */
public class ClaGestionVideoRealisateurGenre extends javax.swing.JDialog {
    ...
    private ClaSelectJlistGenre selectScJlist;
    private ClaSelectJlistRealisateur selectCatJlist;
     ...
     */
    public ClaGestionVideoRealisateurGenre() {

        initComponents(); // OMDB 08.04.2018 : NETBEANS écrit automatiquement cet appel initComponents()
        selectScJlist = new ClaSelectJlistGenre();
        selectCatJlist = new ClaSelectJlistRealisateur();
    ...
    private void jButton1FermerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1FermerActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ClaGestionVideoRealisateurGenre.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                /* OMDB 09.04.2018 : ON DOIT FERMER LA CONNECTION A LA BD. 
                    AINSI PAS DE PROBLEMES LIES A LA MULTIPLICATION DES SESSIONS DE L'UTILISATEUR "root"
    ...
    private void jButton1AjouterSCLibelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1AjouterSCLibelleActionPerformed
        ...
        ClaSelectJlistGenre frame2 = new ClaSelectJlistGenre(intidLibProbSendSelecJlist);
    ...
    private void jButton1AjouterCategorieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1AjouterCategorieActionPerformed
         ...
         */
        ClaSelectJlistRealisateur frameCategorie = new ClaSelectJlistRealisateur(intidLibProbSendSelecJlist);
    ...
    private void requete_id_libelle() {
        try {
            ...
            String sql_select_sc_cat = "SELECT DISTINCT ID_Video, titre FROM T_Video T1\n"
    ...
    private boolean remplir_listes_categories_genres(String choixCurseur, CachedRowSet rowsetrsScCat) {
        ...
        try {
             ...
             */
            idLibProb = rowsetrsScCat.getString("ID_Video");
            // OMDB 08.04.2018 : Affiche l'ID_Video
            jLabel1idLibelle.setText(idLibProb);

            String sql_select_cat_where = "SELECT DISTINCT titre, nom_realisateur FROM T_Video T1\n"
                    + "               LEFT JOIN T_est T2 ON T2.fk_Video = T1.ID_Video\n"
                    + "               LEFT JOIN T_Genre T3 ON T3.ID_Genre = T2.fk_genre\n"
                    + "               INNER JOIN T_Produit T4 ON T4.fk_Video = T1.ID_Video\n"
                    + "               INNER JOIN T_Realisateur T5 ON T5.ID_Realisateur = T4.fk_Realisateur\n"
                    + "               WHERE ID_Video =" + idLibProb;

            String sql_select_sc_where = "SELECT DISTINCT titre, ID_Genre, nom_genre FROM T_Video T1\n"
                    + "               LEFT JOIN T_est T2 ON T2.fk_Video = T1.ID_Video\n"
                    + "               LEFT JOIN T_Genre T3 ON T3.ID_Genre = T2.fk_genre\n"
                    + "               INNER JOIN T_Produit T4 ON T4.fk_Video = T1.ID_Video\n"
                    + "               INNER JOIN T_Realisateur T5 ON T5.ID_Realisateur = T4.fk_Realisateur\n"
            ...
            while (rsCat.next()) {
                ...
                jTextArea1Libelle.setText(rsCat.getString("titre"));
                ...
                String nomCategorie = rsCat.getString("nom_realisateur");
            ...
            while (rsSc.next()) {
                // OMDB 04.04.2018 : Afficher le libellé dans une zone de textarea
                jTextArea1Libelle.setText(rsSc.getString("titre"));
                ...
                String nomSousCategorie = rsSc.getString("nom_genre");
    ...
    public boolean effacerLibelleSousCategorieBD() {
        ...
        // OMDB 15.04.2018 : Requête pour rechercher l'id de la ligne à effacer (ID_Produit) dans la table de liaison entre les LIBELLES et les SOUS CATEGORIES
        String sql_idVideoGenre = "SELECT ID_est FROM T_est WHERE fk_Video = ? AND fk_Genre = \n"
                + " (SELECT ID_Genre FROM T_Genre WHERE nom_genre COLLATE utf8_unicode_ci LIKE ?)";

        // OMDB 15.04.2018 : Requête pour EFFACER la ligne (ID_Produit) dans la table de liaison entre les LIBELLES et les SOUS CATEGORIES        
        String sql_DeleteidLibelleSousCat = "DELETE FROM T_est WHERE ID_est = ?";
        ...
        try {
            ...
            if (selectedIdx.length == 0) {
                ...
                while (i < nbValuesSelected) {
                    ...
                    PreparedStatement pstRechidLibelleSousCat = ClaConnectionBd.getConnection().prepareStatement(sql_idVideoGenre);
                    ...
                    idLibelleSousCat = rsRechidLibelleSousCat.getInt("ID_est");
    ...
    public boolean effacerLibelleCategorieBD() {
        ...
        String sql_idLibelleCat = "SELECT ID_Produit  FROM T_Produit WHERE fk_Video = ? AND fk_Realisateur = \n"
                + " (SELECT ID_Realisateur FROM T_Realisateur WHERE nom_realisateur COLLATE utf8_unicode_ci LIKE ?)";
        ...
        String sql_DeleteidLibelleCat = "DELETE FROM T_Produit WHERE ID_Produit = ?";
        ...
        try {
            ...
            if (selectedIdx.length == 0) {
                ...
                while (i < nbValuesSelected) {
                    ...
                    // OMDB 15.04.2018 : Récupérer le numéro de la ligne à effacer
                    idLibelleCat = rsRechidLibelleCategorie.getInt("ID_Produit");
                    // LIGNE INUTILE...JUSTE POUR RASSURER LA PERSONNE QUI EST EN TRAIN DE CODER.....
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClaGestionVideoRealisateurGenre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClaGestionVideoRealisateurGenre().setVisible(true);
            }
        });
    }
