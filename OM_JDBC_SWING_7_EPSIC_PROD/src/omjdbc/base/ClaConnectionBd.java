...
public class ClaConnectionBd {
    ...
    private static final String CHAINE_CONNECT_DB = "jdbc:mysql://127.0.0.1:3307/Film_Nicolas";
    ...
    public static Connection getConnection()
    {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClaGestionGenre.class.getName()).log(Level.SEVERE, null, ex);
